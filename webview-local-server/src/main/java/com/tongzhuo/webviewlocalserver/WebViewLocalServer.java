package com.tongzhuo.webviewlocalserver;
...
public class WebViewLocalServer {
    ...
    WebViewLocalServer(AndroidProtocolHandler protocolHandler, String authority) {
     ...
     * @param authority like androidplatform.net or a domain you own
     */
    ...
    public WebResourceResponse shouldInterceptRequest(WebResourceRequest request) {
        ...
        Log.e(WebViewLocalServer.class.getName(), "PathHandler is null : " + (handler == null));
        if (handler == null) {
            return null;
        }
    ...
    public AssetHostingDetails hostStorage(final String storagePath,
    ...
    public AssetHostingDetails hostStorage(final String domain,
        ...
        PathHandler handler = new PathHandler() {
            ...
            public InputStream handle(Uri url) {
                ...
                try {
                    ...
                    Log.e(TAG, "openStorage storage success , path = "+path);
                } catch (Exception e) {
